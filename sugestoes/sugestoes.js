        ...
        const handleSubmit = (event) => {
            ...
            if (this.formValidate(this.textarea.value)) {
                ...
                <div class="actionBtnPost">
                    <button type="button" id="clickButton${this.amountButtons}" onclick="curtir(${this.amountButtons})" class="filesPost like"><img src="Imagens/heart.svg" alt="Curtir">Curtir</button>
